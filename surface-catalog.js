...
(() => {
  ...
  function summarize(patch,example,number){
    ...
    return {
      ...
      errorKey:errorKey(data.error),syndromeKey:syndromeKey(data.observed),error:data.error,syndrome:data.observed.slice(0,20),
